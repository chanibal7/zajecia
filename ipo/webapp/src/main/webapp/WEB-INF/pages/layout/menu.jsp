        ...
        <div class="navi-wrap">
          ...
          <div class="clearfix hidden-xs text-center hide" id="aside-user">
            <div class="dropdown wrapper">
              ...
              <a href="#" data-toggle="dropdown" class="dropdown-toggle hidden-folded">
                <span class="clear">
                  <span class="block m-t-sm">
                    <strong class="font-bold text-lt">Peter.Muller</strong> 
                    <b class="caret"></b>
                  </span>
              ...
              <ul class="dropdown-menu animated fadeInRight w hidden-folded">
                ...
                <li>
                  <a href="${ctx}/login.htm">Profile</a>
                </li>
                <li>
                  <a href>
          ...
          <nav ui-nav class="navi clearfix">
            <ul class="nav">
              ...
              <li>
                <a href="${ctx}/privacy.htm" class="auto">      
                  <span class="pull-right text-muted">
                    <i class="fa fa-fw fa-angle-right text"></i>
                    <i class="fa fa-fw fa-angle-down text-active"></i>
                  </span> Privacy, Terms and conditions
                </a>
              </li>
             <%--  <li>
                <a href="${ctx}/terms.htm" class="auto">      
                  <span class="pull-right text-muted">
                    <i class="fa fa-fw fa-angle-right text"></i>
                    <i class="fa fa-fw fa-angle-down text-active"></i>
                  </span>
               ...
               <li>
                <a href="${ctx}/contact.htm" class="auto">      
                  <span class="pull-right text-muted">
                    <i class="fa fa-fw fa-angle-right text"></i>
                    <i class="fa fa-fw fa-angle-down text-active"></i>
                  </span>
