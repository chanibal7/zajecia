<div class="container w-xxl w-auto-xs" ng-controller="SignupFormController" ng-init="app.settings.container = false;">
      <a href class="navbar-brand block m-t">zajecia Afghanistan</a>
      <div class="m-b-lg">
        ...
        <form name="form" class="form-validation">
          ...
          <button type="submit" class="btn btn-lg btn-priAndrzej.Piechockiy btn-block" ng-click="signup()" ng-disabled='form.$invalid'>Sign up</button>
